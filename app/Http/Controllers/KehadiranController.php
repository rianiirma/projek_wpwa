...
class KehadiranController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('kehadiran.create', compact('anggota', 'kegiatan'));
    }
    ...
    public function edit(Kehadiran $kehadiran)
    {
        $anggota  = Anggota::all();
        $kegiatan = Kegiatan::all();
        return view('kehadiran.edit', compact('kehadiran', 'anggota', 'kegiatan'));
    }
    ...
    public function update(Request $request, Kehadiran $kehadiran)
    {
        ...
        return redirect()->route('kehadiran.index')->with('success', 'Data kehadiran berhasil diupdate');
    }
